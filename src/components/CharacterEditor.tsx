...
export default function CharacterEditor({ characters, onCharactersChange, onClose }: CharacterEditorProps) {
            ...
            <div className="character-list">
              ...
              <div className="character-items">
                {characters.map(character => (
                  <div
                    key={character.id}
                    className={`character-item ${selectedCharacterId === character.id ? 'active' : ''}`}
                    onClick={() => selectCharacter(character)}
                  >
                    <div className="character-avatar">
                      {character.referenceImage ? (
                        <img src={character.referenceImage} alt={character.name} />
                      ) : (
                ...
                <div className="character-form">
                  ...
                  <div className="form-row">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => updateCharacter({ age: parseInt(e.target.value) || undefined })}
                        placeholder="Âge"
                        min="1"
                        max="200"
                      />
                    ...
                    <div className="form-group">
                      <label>Genre</label>
                      <select
                        value={editingCharacter.gender || 'non-spécifié'}
                  ...
                  <div className="form-group">
                    ...
                    <textarea
                      ...
                      placeholder="Description générale du personnage, son rôle dans l'histoire..."
                      rows={3}
                    />
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <textarea
                      ...
                      placeholder="Apparence physique détaillée : cheveux, yeux, taille, vêtements, style..."
                      rows={4}
                    />
                  ...
                  <div className="form-group">
                    ...
                    <textarea
                      ...
                      placeholder="Traits de personnalité, comportement, façon de parler..."
                      rows={3}
                    />
                  </div>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      type="url"
                      value={editingCharacter.referenceImage || ''}
                      onChange={(e) => updateCharacter({ referenceImage: e.target.value })}
                      placeholder="URL d'une image de référence"
                    />
                    {editingCharacter.referenceImage && (
                      <div className="reference-preview">
                        <img 
                          src={editingCharacter.referenceImage} 
                          alt="Référence" 
                          onError={(e) => {
